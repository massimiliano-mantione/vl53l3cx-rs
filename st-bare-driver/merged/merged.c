...
#define GPIO_POWER_ENABLE       2
#define GPIO_XSHUTDOWN          3
#define GPIO_SPI_CHIP_SELECT    4
	...
	uint32_t      count)
{
	...
	{
		if((CP_STATUS)unimplemented() != CP_STATUS_OK)
		{
			status = VL53LX_ERROR_CONTROL_INTERFACE;
		}
